...
LightModelling - это WPF приложение для просмотра STL моделей с расширенными возможностями управления освещением. Приложение позволяет добавлять различные типы источников света, визуализировать лучи с отражениями от поверхностей моделей, а также управлять камерой и объектами в 3D пространстве.
...
[yurchik228336](https://github.com/yurchik228336)

## Благодарности

- [HelixToolkit](https://github.com/helix-toolkit/helix-toolkit) - за отличную библиотеку для 3D визуализации в WPF
